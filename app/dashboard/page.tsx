...
export default function DashboardPage() {
  ...
  useEffect(() => {
    // 1. Recupera o carimbo de segurança que o Java enviou no login
  ...
  // 🧠 ROTEAMENTO RÍGIDO DE PERFIS (Multi-Tenant View Isolation)
  switch (usuario.tipoUsuario) {
    case 'ADMIN':
      // Apenas você/sua equipe master visualiza o ecossistema macro
    ...
    default:
      // Se vier um tipo desconhecido, desloga por segurança
